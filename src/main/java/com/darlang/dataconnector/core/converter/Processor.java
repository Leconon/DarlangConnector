...
public class Processor {
    ...
    /*public static void lineToSQLConverter(List<Object> queryObject, int lineIndex, Connection connection) throws Exception {
    ...
    private void createSqlFromLine(int lineIndex) {
